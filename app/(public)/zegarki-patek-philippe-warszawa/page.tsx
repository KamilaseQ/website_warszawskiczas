...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'pl_PL',
    images: [{ url: absoluteStaticImageUrl(STATIC_IMAGES.patek), alt: 'Patek Philippe — Warszawski Czas, Mokotowska 71' }],
  },
  ...
  return (
    <>
      ...
      <SeoLanding
        ...
        heroImage={{ src: STATIC_IMAGES.patek, alt: 'Patek Philippe — butik Warszawski Czas, Mokotowska 71' }}
        body={[
          {
